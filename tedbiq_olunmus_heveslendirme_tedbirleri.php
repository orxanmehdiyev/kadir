...
<script type="text/javascript">
	...
	document.getElementById("SeyfeAdi").innerHTML = "Tədbiq olunmuş həvəsləndirmə tədbirləri";
</script>
				...
				<div  class="ListelemeAlaniIciTabloAlaniKapsayicisi">
					<table style="white-space: normal;" class="table table-bordered table-hover" id="dataTable">
						...
						<tbody>
							...
							$Hevs_Sor=$db->prepare("SELECT * FROM hevesledirme_tedbirleri  order by Hevesledirme_Tedbirleri_Tarix DESC ");
							$Hevs_Sor->execute();	
							while ($Hevs_Cek=$Hevs_Sor->fetch(PDO::FETCH_ASSOC)) {
								...
								<tr class="vertikalmidle">
									...
									<td data-sort="<?php echo $Hevs_Cek['Hevesledirme_Tedbirleri_Tarix'] ?>" class="textaligncenter"><?php echo TarixAzCevir($Hevs_Cek['Hevesledirme_Tedbirleri_Tarix']);?></td>
									<td><?php echo $Hevs_Cek['Heveslendirem_Tedbirleri_Ad'];?></td>
									<td><?php echo $Hevs_Cek['Hevesledirme_Tedbirleri_Emrinin_Nomresi'];?></td>	
								</tr>
								<?php 
