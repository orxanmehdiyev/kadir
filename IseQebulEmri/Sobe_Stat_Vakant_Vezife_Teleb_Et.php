...
?>
<label for="User_Vezife" class="form-label">Vəzifə<span class="KirmiziYazi">*</span></label>
<input type="hidden" id="vakanvezifesayi" value="<?php echo $vakanvezifesayi ?>">
<select class="form-select" required="required"  id="User_Vezife" onchange="SecimAlaniSecildi(this.id)" tabindex="14" title="">
	<option ></option>
	<?php 
