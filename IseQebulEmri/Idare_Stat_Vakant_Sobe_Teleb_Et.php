...
?>
<label for="User_Islediyi_Sobe_Bolme" class="form-label">Şöbə<span class="KirmiziYazi">*</span></label>
<input type="hidden" id="vakansobesayi" value="<?php echo $vakanvezifesayi ?>">
<select class="form-select" id="User_Islediyi_Sobe_Bolme" required="required" onchange="StatSobeVezifeTelebEt(this.id)" tabindex="13" title="">
	<option ></option>
	<?php 
