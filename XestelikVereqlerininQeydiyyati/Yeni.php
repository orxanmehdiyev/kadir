	...
	<div class="row">						
		<form class="row p-2 ">		
			...
			<div class="col-3">
				...
				<input type="text" class="form-control" value="" id="Xestelik_Vereqi_No" oninput="MetinAlaniYazildi(this.id)" onfocusout="MetinAlaniYazildi(this.id),SagVeSolBosluklariSIl(this.id)" required="required" maxlength="10" tabindex="2" title="">
			</div>

			<div class="col-2">
				<label for="Xestelik_Baslagic_Tarixi" style="width: 206px" class="form-label ">Başlanğıc tarixi<span class="KirmiziYazi">*</span></label>
				<input type="text" class="form-control pickmeup_1" autocomplete="off" id="Xestelik_Baslagic_Tarixi" oninput="TarixAlaniYazildi(this.id)" onfocusout="TarixAlaniYazildi(this.id)"  placeholder="__.__._____"  required="required" maxlength="10" tabindex="3" title="">
			</div>

			<div class="col-2">
				<label for="Xestelik_Gun" style="width: 206px" class="form-label ">Günlərin sayı<span class="KirmiziYazi">*</span></label>
				<input type="number" class="form-control" min="1" max="360" id="Xestelik_Gun" oninput="ReqemAlaniYazildi(this.id)" onfocusout="ReqemAlaniYazildi(this.id),SagVeSolBosluklariSIl(this.id)" required="required" title="" onkeydown="javascript: return event.keyCode == 69 ? false : true"  onfocusout="ReqemAlaniYazildi(this.id)" maxlength="3" tabindex="9">
			</div>

			<div class="col-2">
				<label for="Xestelik_Ise_Cixma_Tarixi" style="width: 206px" class="form-label ">İşə çıxma tarixi<span class="KirmiziYazi">*</span></label>
				<input type="text" class="form-control pickmeup_1" autocomplete="off" id="Xestelik_Ise_Cixma_Tarixi" oninput="TarixAlaniYazildi(this.id)" onfocusout="TarixAlaniYazildi(this.id)"  placeholder="__.__._____" required="required" maxlength="10" tabindex="5" title="">
			</div>
