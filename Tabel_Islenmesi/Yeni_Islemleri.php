...
$TabelAy    =  ReqemlerXaricButunKarakterleriSil($deyer['TabelAy']); 
$TabelIl    =  ReqemlerXaricButunKarakterleriSil($deyer['TabelIl']);
$Idare_Id   =  ReqemlerXaricButunKarakterleriSil($deyer['Idare_Id']);
$Stat_Muqavile   =  ReqemlerXaricButunKarakterleriSil($deyer['heyyet']);
$toplusaat = cal_days_in_month(CAL_GREGORIAN, $TabelAy, $TabelIl);
$songun = cal_days_in_month(CAL_GREGORIAN, $TabelAy, $TabelIl);
$ilkgun =01;
$Ayin_Ilk_Gunu=$TabelIl."-".$TabelAy."-".$ilkgun;
$Ayin_Son_Gunu=$TabelIl."-".$TabelAy."-".$toplusaat;
...
<div class="row ">
	<div class="col-12 textaligncenter"><b><?php echo sprintf("%02d", $ilkgun).".".$TabelAy.".".$TabelIl." - ".$toplusaat.".".$TabelAy.".".$TabelIl	 ?></b></div>
</div>
		...
		<table id="tabel" style="white-space: normal;" class="table table-bordered table-hover">
			<thead>
				<tr >												
					...
					<th rowspan="2" style="transform: rotate(-90deg); width: 30px; text-align: center; height: 56px;background-color: transparent;">İş<br>günləri</th>
