...
document.getElementById("SeyfeAdi").innerHTML = "Vəzifəyə təyin etmə əmirləri";
...
function Yeni() {		
	...
	xhttp.open("POST", "VezifeyeTeyinEtme/Yeni.php", true);
...
function SelectIkiAlaniSecildi(deyer) {
	...
	var xhttp = new XMLHttpRequest();
	xhttp.open("POST", "VezifeyeTeyinEtme/Melumat_Telebi.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send("ID=" + ID);
...
function VakanYerleriSay(id) {
	...
	document.getElementById("yuklemealanikapsayici").style.display = "block";
	var xhttp = new XMLHttpRequest();
	xhttp.open("POST", "VezifeyeTeyinEtme/Vakant.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function StatIdareSobeTelebEt(id) {
	...
	document.getElementById("yuklemealanikapsayici").style.display = "block";
	var xhttp = new XMLHttpRequest();
	xhttp.open("POST", "VezifeyeTeyinEtme/Idare_Stat_Vakant_Sobe_Teleb_Et.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function StatSobeVezifeTelebEt(id) {
	...
	document.getElementById("yuklemealanikapsayici").style.display = "block";
	var xhttp = new XMLHttpRequest();
	xhttp.open("POST", "VezifeyeTeyinEtme/Vakant_Vezife_Teleb_Et.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function YeniFormIslemi() {
	...
	var xhttp = new XMLHttpRequest();
	console.log(xhttp);
	xhttp.open("POST", "VezifeyeTeyinEtme/Yeni_Islemleri.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function Sil_Tesdiq(id) {
	document.getElementById("yuklemealanikapsayici").style.display = "block";
	var xhttp = new XMLHttpRequest();
	xhttp.open("POST", "VezifeyeTeyinEtme/Sil_Islemleri.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send("Deyer=" + id);
	console.log(xhttp);
	xhttp.onreadystatechange = function (deyer) {		
...
function	Axtar(){
	...
	$.ajax({
		type:"post",
		url:"VezifeyeTeyinEtme/Axtaris.php",
		data:veri,
