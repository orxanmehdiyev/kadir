...
if (isset($_POST['yeni'])) {?>
	<div class="row">						
		<form class="row g-3 p-2 ">		
			<div class="col-6">
				...
				<select id="ID" required="required" class="js-example-placeholder-single form-select" onchange="SelectIkiAlaniSecildi(this.id)" title="">
					...
					while ($User_Cek=$User_Sor->fetch(PDO::FETCH_ASSOC)) {					
						...
						echo "<option value='".$User_Cek['ID'] ."'>".$User_Cek['Soy_Adi']." ".$User_Cek['Adi']." ".$User_Cek['Ata_Adi']."</option>";
					}
			...
			<hr>
			<div class="col-6">
				<label for="Idare_Ad" class="form-label">Azad edildyi idarə</label>
				<input type="tarix" class="form-control"  id="Idare_Ad"  readonly  title="">
			</div>

			<div class="col-4">
				<label for="Sobe_Ad" class="form-label">Azad edildyi Şöbə/Bölmə</label>
				<input type="tarix" class="form-control"  id="Sobe_Ad" readonly title="">
			</div>

			<div class="col-2">
				<label for="Vezife_Ad" class="form-label">Azad edildyi vəzifə</label>
