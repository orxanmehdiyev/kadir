...
if (isset($_POST['yeni'])) {?>
	<div class="row">						
		<form class="row p-2 ">		
			...
			<div class="col-5">
				<label for="Attestasiya_Qerar	" class="form-label">Qərar<span class="KirmiziYazi">*</span></label>
				<select id="Attestasiya_Qerar" required="required" class="form-select" onchange="SelectAlaniSecildi(this.id)" title="">
					<option disabled="disabled" value="" selected="selected" tabindex="7"></option>				
					<option value="0">Tutduğu vəzifəyə uyğundur</option>
					<option value="1">İşini yaxşılaşdırarsa və komissiyanın tövsiyələrini yerinə yetirərsə,1 ildən sonra təkrar attestasiyadan keçmək şərti ilə tutduğu vəzifəyə uyğundur</option>
					<option value="2">Tuduğu vəzifəyə uyğun deyil</option>										
				</select>
			</div>	
			<div class="col-2 tarixdivi">
				<label for="Attestasiya_Tarix" class="form-label">Tarixi<span class="KirmiziYazi">*</span></label>
				<input type="text" class="form-control pickmeup_1 tarix" autocomplete="off" oninput="TarixAlaniYazildi(this.id)" onfocusout="TarixAlaniYazildi(this.id)" placeholder="<?php echo $TekTarix ?>" onchange="TarixAlaniYazildi(this.id)" maxlength="10" id="Attestasiya_Tarix"  title="">
			</div>
			<div class="col-1 atestbal">
				<label for="Topladigi_Bal" class="form-label">Bal<span class="KirmiziYazi">*</span></label>
				<input required="required" type="number"  class="form-control sinaqmuddetigun" min="0" max="365" id="Topladigi_Bal" oninput="ReqemAlaniYazildi(this.id)" title="" onkeydown="javascript: return event.keyCode == 69 ? false : true"  onfocusout="ReqemAlaniYazildi(this.id)" maxlength="3" tabindex="9">
			</div>		

			<div class="col-2 atestaiemirno">
				<label for="Attestasiya_Emr_No" class="form-label">Əmir №<span class="KirmiziYazi">*</span></label>
				<input required="required" type="text"  class="form-control sinaqmuddetigun" min="0" max="365" id="Attestasiya_Emr_No" oninput="MetinAlaniYazildi(this.id)" title="" onkeydown="javascript: return event.keyCode == 69 ? false : true"  onfocusout="MetinAlaniYazildi(this.id)" maxlength="3" tabindex="9">
			</div>	
			<hr>
			<div class="col-6">
