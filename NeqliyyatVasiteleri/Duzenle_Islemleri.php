...
if (isset($_POST['Deyer'])) {
	...
	$Neqliyyat_Vasiteleri_Id=ReqemlerXaricButunKarakterleriSil($deyer['Neqliyyat_Vasiteleri_Id']);
	...
	if ($Dovlet_Nom_Nisani=="") {
	...
	else	if ($Neqliyyat_Vasiteleri_Id=="") {
		...
		$Elave_Et=$db->prepare("UPDATE neqliyyat_vasiteleri SET                               
			...
			Rengi=:Rengi
			where Neqliyyat_Vasiteleri_Id=$Neqliyyat_Vasiteleri_Id
			");
