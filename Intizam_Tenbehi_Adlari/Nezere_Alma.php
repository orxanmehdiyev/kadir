...
if ($IntizamTenbehiAdlariNezerealma==1 and $IntizamTenbehiAdlariNezerealmaGoster==1) {
...
$intizam_tenbehi_adlari_id  = ReqemlerXaricButunKarakterleriSil($_POST['Deyer']);
	...
	if ($Cek['intizam_tenbehi_adlari_nezere_alam']==0) {
		$intizam_tenbehi_adlari_nezere_alam=1;
	}else{
