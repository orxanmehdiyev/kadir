...
if (isset($_POST['Deyer'])) {
	...
	$Xarici_Dil_Ad=EditorluIcerikleriFiltrle($deyer['Xarici_Dil_Ad']);
	$Xarici_Dil_Sevye=EditorluIcerikleriFiltrle($deyer['Xarici_Dil_Sevye']);
	$Xarici_Dil_Id=EditorluIcerikleriFiltrle($deyer['Xarici_Dil_Id']);
	...
	if ($Xarici_Dil_Ad!="" and $Xarici_Dil_Sevye!="" and $User_Say==1) {
		$Elave_Et=$db->prepare("UPDATE xarici_dil SET                               
			ID=:ID,
			Xarici_Dil_Ad=:Xarici_Dil_Ad,
			Xarici_Dil_Sevye=:Xarici_Dil_Sevye
			where Xarici_Dil_Id=$Xarici_Dil_Id");
		...
		if ($Insert) {				
			...
			$Insert=$Elave_Et->execute(array(                                
				'Xarici_Dil_Id'=>$Xarici_Dil_Id,
				'Xarici_Dil_Islemleri_Islem_Sebebi'=>2,
				'Admin_Id'=>$Admin_Id,
				'ZamanDamgasi'=>$ZamanDamgasi,
				'TarixSaat'=>$TarixSaat,
				'IPAdresi'=>$IPAdresi,
