...
if (isset($_POST['Deyer'])) {
	...
	$Hevesledirme_Tedbirleri_User_Id=ReqemlerXaricButunKarakterleriSil($deyer['ID']);
					...
					if ($Hevesledirme_Tedbirleri_Tarix!="") {			
						...
						if ($Insert) {
							...
							$Insert=$Elave_Et->execute(array(                                
								...
								'Admin_Soyad'=>$Admin_Soyad,
								'Admin_Ataadi'=>$Admin_Ataadi,
								'Hevesledirme_Tedbirleri_Islemleri_Islem_Sebebi'=>5,
								'Hevesledirme_Tedbirleri_Tesdiq_Durumu'=>1
							));
							if ($Insert) {
								...
								$Heveslendirme_Tedbiri_Sor->execute(array(
									...
									$sil = $db->prepare("DELETE from hevesledirme_tedbirleri_islemleri where Hevesledirme_Tedbirleri_Id=:Hevesledirme_Tedbirleri_Id");
