...
if (isset($_POST['Deyer'])) {
	...
	if ($Ezam_Olundugu_Yer!="" and $Ezam_Sebebi!="" and $Ezam_Baslangic_Tarixi_Unix!="" and $Ezam_Baslangic_Tarixi!="" and $Ezam_Bitis_Tarixi_Unix!="" and $Ezam_Bitis_Tarixi!="" and $Ezam_Emri_No!="" and $User_Say==1 and $Ezam_Gun_Sayi!="") {
		...
		if ($Insert) {
			$Ezamiyye_Emri_Id=$db->lastInsertId();
