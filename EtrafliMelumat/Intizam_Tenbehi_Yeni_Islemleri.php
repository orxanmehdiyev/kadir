...
if (isset($_POST['Deyer'])) {
	...
	$Intizam_Tenbehi_User_Id=ReqemlerXaricButunKarakterleriSil($deyer['ID']);
						...
						if ($Intizam_Tenbehinin_Bitis_Tarixi!="") {			
							...
							if ($Insert) {
								...
								$Insert=$Elave_Et->execute(array(                                
									...
									'Intizam_Tenbehi_Islemleri_Sebeb'=>1,
									'Admin_Id'=>$Admin_Id,
								));
								if ($Insert) {?>
									<?php 
													...
													<tbody>
														...
														while($Intizam_Cek=$Intizam_Sor->fetch(PDO::FETCH_ASSOC)) {
															...
															<tr>
																...
																<td><?php echo $Intizam_Cek['Intizam_Tenbehi_Emrinin_Nomresi'] ?></td>										
																<td class="emeliyyatlar_iki_buttom">
																	<button class="YenileButonlari" id="IntizamTedbiriDuzenle<?php echo $Intizam_Cek['Intizam_Tenbehi_Id'] ?>" onclick="IntizamTedbiriDuzenle(this.id)" type="button">
																		<i class="fas fa-edit"></i>
																	</button>		
																	<button class="YenileButonlari" id="IntizamTedbiriSil<?php echo $Intizam_Cek['Intizam_Tenbehi_Id'] ?>" onclick="IntizamTedbiriSil(this.id)" type="button">
																		<i class="fas fa-trash"></i>
																	</button>
																</td>
															</tr>
