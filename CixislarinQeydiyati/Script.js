...
document.getElementById("SeyfeAdi").innerHTML = "Çıxışların qeydiyatı";
...
function Yeni() {		
	...
	xhttp.open("POST", "CixislarinQeydiyati/Yeni.php", true);
...
function SelectIkiAlaniSecildi(deyer) {
	...
	var xhttp = new XMLHttpRequest();
	xhttp.open("POST", "CixislarinQeydiyati/Melumat_Telebi.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send("ID=" + ID);
...
function YeniFormKontrol() {
	...
	var Cixis_Sebebi = document.getElementById("Cixis_Sebebi");
	if(ID.value === '') {
...
function YeniFormIslemi() {
	...
	var deyer = {
		ID:ID.value,
		Cixis_Sebebi:Cixis_Sebebi.value
	};
	document.getElementById("yuklemealanikapsayici").style.display = "block";
	var gonderilen=JSON.stringify(deyer);
	var xhttp = new XMLHttpRequest();
	xhttp.open("POST", "CixislarinQeydiyati/Yeni_Islemleri.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function Sil_Tesdiq(id) {
	document.getElementById("yuklemealanikapsayici").style.display = "block";
	var xhttp = new XMLHttpRequest();
	xhttp.open("POST", "CixislarinQeydiyati/Sil_Islemleri.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send("Deyer=" + id);
	xhttp.onreadystatechange = function (deyer) {		
		document.getElementById("yuklemealanikapsayici").style.display = "none";
...
function	Axtar(){
	...
	$.ajax({
		type:"post",
		url:"CixislarinQeydiyati/Axtaris.php",
		data:veri,
